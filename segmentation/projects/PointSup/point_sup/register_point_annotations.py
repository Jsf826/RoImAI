...
_PREDEFINED_SPLITS_COCO["coco"] = {
    ...
    "ssmg_coco_2017_train_points_n10_v1_without_masks": (
        "ssmg_coco/train2017",
        "ssmg_coco/annotations/instances_train2017_n10_v1_without_masks.json",
    ),
    "ssmg_coco_2017_val": (
        "ssmg_coco/val2017",
        "ssmg_coco/annotations/instances_val2017.json",
    )
}

def get_ssmg_metadata():
    return {
        "thing_classes": ["颗粒"],
