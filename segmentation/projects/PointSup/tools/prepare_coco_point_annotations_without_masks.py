...
os.environ["DETECTRON2_DATASETS"] = "/home/pan/FJS/MC/detectron2-main/detectron2-main/projects/PointSup/datasets"
...
if __name__ == "__main__":
    ...
    dataset_dir = os.path.join(os.getenv("DETECTRON2_DATASETS", "datasets"), "ssmg_coco/annotations")
